...
router.get("/own", authMiddleware, (req, res) =>
  placeController.getOwnPlaces(req, res)
);
...
router.post("/:place_id/equipments", authMiddleware, (req, res) =>
  placeController.addEquipmentToPlace(req, res)
);

router.delete(
  "/:place_id/equipments/:equipmentId",
  authMiddleware,
  (req, res) => placeController.removeEquipmentFromPlace(req, res)
);
